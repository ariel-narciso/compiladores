...
int main(){
    ...
    code[13].f = JPC; code[13].l = 0; code[13].a = 24;
    code[14].f = LOD; code[14].l = 0; code[14].a = 3;
    code[15].f = LIT; code[15].l = 0; code[15].a = 1;
    code[16].f = OPR; code[16].l = 0; code[16].a = 3;
    code[17].f = STO; code[17].l = 0; code[17].a = 8;
    code[18].f = CAL; code[18].l = 0; code[18].a = 9;
    code[19].f = LOD; code[19].l = 0; code[19].a = 9;
    ...
    code[24].f = LIT; code[24].l = 0; code[24].a = 1;
